  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section
        ...
        style={{
          background: "linear-gradient(180deg, #0a0a14 0%, #0f0820 50%, #0a0a14 100%)",
        }}
      >
        {/* BG Blobs */}
        <div
        ...
        />
        <div
          className="absolute bottom-10 right-1/4 w-96 h-96 rounded-full blur-3xl pointer-events-none"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Link
              href="/products"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-white font-semibold text-base transition-all hover:opacity-90 glow-purple"
      ...
      <section className="py-20" style={{ background: "#0a0a14" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">가장 많이 찾는 프리미엄 서비스들을 한눈에 확인하세요</p>
          </div>
            ...
            {popularProducts.map((product) => (
              ...
              >
                ...
                <div className="flex items-start justify-between">
                  <div
                    className={`w-14 h-14 rounded-2xl ${product.bgColor} flex items-center justify-center text-white font-bold text-lg`}
                  >
                    {product.icon}
                  </div>
                  <span
                ...
                >
                  <div>
                    <div className="text-gray-600 text-xs line-through">
                      정가 {highestOriginal(product).toLocaleString()}원/월
                    </div>
                    <div className="text-white font-bold text-xl">
                      <span className="text-purple-400">
                        {lowestPrice(product).toLocaleString()}원
                      </span>
                      <span className="text-gray-500 text-sm font-normal">/월부터</span>
                    </div>
                  </div>
                  <span
      ...
      <section
        id="features"
        className="py-20"
        style={{ background: "linear-gradient(180deg, #0a0a14, #0f0820, #0a0a14)" }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
            ...
            <p className="text-gray-400">합리적인 가격, 안전한 거래, 빠른 서비스</p>
          </div>
            ...
            {[
              {
                icon: "⚡",
                title: "즉시 자동 배송",
                description: "결제 완료 즉시 계정 정보가 자동으로 전송됩니다. 24/7 언제든지 구매 가능합니다.",
              },
              {
                icon: "🔐",
                title: "안전한 거래",
                description: "SSL 암호화로 모든 결제 정보를 안전하게 보호합니다. 개인정보는 절대 공유하지 않습니다.",
              },
              {
                icon: "💰",
                title: "최대 85% 할인",
                description: "그룹 구독을 통해 최대 85%까지 절약할 수 있습니다. 동일한 서비스를 훨씬 저렴하게 이용하세요.",
              },
              {
                icon: "🛡️",
                title: "30일 환불 보장",
                description: "서비스 이용에 문제가 생기면 30일 이내 전액 환불해 드립니다. 안심하고 구매하세요.",
              },
              {
                icon: "📱",
                title: "모든 기기 지원",
                description: "스마트폰, 태블릿, PC, TV 등 모든 기기에서 동일하게 이용할 수 있습니다.",
              },
              {
                icon: "🎧",
                title: "24/7 고객지원",
                description: "문제가 생기면 언제든지 연락주세요. 빠른 시간 내에 해결해 드리겠습니다.",
              },
            ].map((feature) => (
              <div
                key={feature.title}
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-20" style={{ background: "#0a0a14" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">이용 방법</h2>
            <p className="text-gray-400">4단계로 간단하게 프리미엄 서비스를 시작하세요</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={item.step} className="relative text-center">
                ...
                <div
                  className="w-16 h-16 rounded-2xl flex items-center justify-center text-white font-bold text-xl mx-auto mb-4 relative z-10"
                  style={{ background: "linear-gradient(135deg, #7c3aed, #4f46e5)" }}
                >
                  {item.step}
                </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-sm">3,674개의 리뷰 기준</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {reviews.map((review, i) => (
              ...
              >
                ...
                <p className="text-gray-400 text-sm leading-relaxed mt-3">{review.content}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* FAQ */}
      <section id="faq" className="py-20" style={{ background: "#0a0a14" }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              {
                q: "공유 계정은 안전한가요?",
                a: "네, 안전합니다. 저희는 각 서비스의 공식 패밀리/그룹 구독 기능을 이용하기 때문에 서비스 약관을 위반하지 않습니다. 개인 프로필이 분리되어 다른 사람의 시청 기록을 볼 수 없습니다.",
              },
              {
                q: "구매 후 언제 계정 정보를 받을 수 있나요?",
                a: "결제 완료 즉시 자동으로 이메일 또는 SMS로 계정 정보가 전송됩니다. 보통 1분 이내에 받을 수 있습니다.",
              },
              {
                q: "서비스 이용 중 문제가 생기면 어떻게 하나요?",
                a: "30일 이내에 문제가 발생하면 전액 환불 또는 재발급을 해드립니다. 고객센터로 문의해 주세요.",
              },
              {
                q: "여러 기기에서 동시에 사용할 수 있나요?",
                a: "서비스별로 허용 기기 수가 다릅니다. 각 서비스의 기기 정책을 따르며, 대부분 개인 기기에서 자유롭게 사용할 수 있습니다.",
              },
              {
                q: "결제 수단은 무엇이 있나요?",
                a: "신용카드, 체크카드, 계좌이체, 카카오페이, 토스 등 다양한 결제 수단을 지원합니다.",
              },
            ].map((faq, i) => (
              <div
                key={i}
      ...
      {/* CTA Banner */}
      <section className="py-20" style={{ background: "#0f0820" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-8">
              수십만 명이 이미 SubsShare로 비용을 절약하고 있습니다
            </p>
            <Link
              href="/products"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl text-white font-bold text-lg transition-all hover:opacity-90 glow-purple"
              style={{ background: "linear-gradient(135deg, #7c3aed, #4f46e5)" }}
            >
              서비스 둘러보기 →
            </Link>
